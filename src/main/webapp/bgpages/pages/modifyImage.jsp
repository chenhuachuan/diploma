...
<div class="row clearfix">
    <div class="col-sm-12 column">
        <form id="ImagesDetail_form_id_1" method="post"
              role="form" data-options="novalidate:true" class="form-horizontal" enctype="multipart/form-data"
              style="margin-top: 10px">
            <input class="easyui-textbox" type="hidden" name="imageId" value="${imageInfo.imageId}"/>

            <div class="form-group-separator"></div>
            <div class="form-group">
                <label class="col-sm-1 control-label">位置</label>
                <div class="col-sm-5">
                    <input class="easyui-combobox" name="type" id="add_type" style="width: 230px;"
                ...
                <div class="col-sm-5">
                    <input class="easyui-combobox" name="status" id="add_status" style="width: 230px;"
                           value="${imageInfo.status}"
                           data-options="valueField:'id',textField:'text',required:true,
                            data:[
                                {id:1,text:'启用'},
                                {id:0,text:'暂不启用'}
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <textarea class="form-control" id="add_imageDesc" rows="3" name="imageDesc"
                              style="margin-left: 23px" data-options="required:true"
                              name=textarea>${imageInfo.imageDesc}</textarea>
                </div>
            </div>
            <div class="form-group-separator"></div>
            <div class="form-group">
                ...
                <div class="col-sm-5" id="img_upload2">
                    <input type="file" id="add_imgUrl" name="imgUrl" onchange="view_photo()" style="width:230px">
                </div>
                <div class="col-sm-5" style="height: 110px;" id="showImageDivId">
                    <img id="showImageId" width="230" height="110"
                         src="${pageContext.request.contextPath}/${imageInfo.imageUrl}"/>
                </div>
            </div>
        </form>
    </div>
